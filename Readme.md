...
# Parsing + Configuration Script – CargaDatos - Rev. A

This **Parsing + Configuration** script is designed for the **CargaDatos** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – CargaDatos Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **CargaDatos** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
